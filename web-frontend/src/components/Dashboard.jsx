/**
 * Dashboard Component
 * Main dashboard displaying equipment analytics, charts, and health status.
 * Features: type distribution, parameter averages, outlier alerts, threshold config.
 */
...
import {
    ...
    getChartColorArray,
    getChartBorderArray,
    zoomOptions as defaultZoomOptions,
    createTooltipConfig
} from '../chartConfig';
